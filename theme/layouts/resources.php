<section class="resources-wrapper">
    <div class="grid-container">
        <p class="resources-subtitle"><?php the_sub_field('pretitle'); ?></p>
        ...
        <div class="grid-x grid-margin-x">
            ...
            <div class="cell medium-8">
                ...
                if ($query->have_posts()) {
                    ...
                    <a href="<?php if ($redirect = get_field('redirect')) { echo $redirect; } else { the_permalink(); } ?>" class="second-resource"<?php if ($redirect) { ?> target="_blank"<?php } ?>>
                        <div class="grid-x">
                ...
                while ($query->have_posts()) {
                    ...
                    <a href="<?php if ($redirect = get_field('redirect')) { echo $redirect; } else { the_permalink(); } ?>" class="subsequent-resource"<?php if ($redirect) { ?> target="_blank"<?php } ?>>
                        <div class="grid-x">
